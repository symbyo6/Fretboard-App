...
import type { PitchClass, NotationPreference } from '../../types';
...
export function KeySelector({ value, notation, onChange }: KeySelectorProps): JSX.Element {
  return (
    <fieldset
    ...
    >
      ...
      >
        {ALL_PITCHES.map((pitch) => {
          ...
          const label = getNoteName(pitch, notation);
